...
namespace Bamboozled
{
	...
	public class Bamboozled : BaseUnityPlugin
	{
...

		{
			...
			//GameObject OP_Bamboo_Angle_Beam_25 = ItemManager.PrefabManager.RegisterPrefab("bamboo", "OP_Bamboo_Angle_Beam_25");
			...
			//GameObject OP_Bamboo_Angle_Beam_45 = ItemManager.PrefabManager.RegisterPrefab("bamboo", "OP_Bamboo_Angle_Beam_45");
			...
			//OP_Bamboo_Short_Beam_1.RequiredItems.Add("OP_Bamboo_Wood", 2, true);
			//GameObject OP_Bamboo_Short_Beam_1 = ItemManager.PrefabManager.RegisterPrefab("bamboo", "OP_Bamboo_Short_Beam_1");
			...
			//OP_Bamboo_Short_Beam_2.RequiredItems.Add("OP_Bamboo_Wood", 2, true);
			//GameObject OP_Bamboo_Short_Beam_2 = ItemManager.PrefabManager.RegisterPrefab("bamboo", "OP_Bamboo_Short_Beam_2");
			...
			//OP_Bamboo_Straw_Gate.RequiredItems.Add("OP_Bamboo_Wood", 2, true);
			...
			//GameObject OP_Bamboo_Wall_Top_25 = ItemManager.PrefabManager.RegisterPrefab("bamboo", "OP_Bamboo_Wall_Top_25");
			...
			//GameObject OP_Bamboo_Wall_Top_45 = ItemManager.PrefabManager.RegisterPrefab("bamboo", "OP_Bamboo_Wall_Top_45");
			...
			//GameObject OP_Bamboo_Wall_25 = ItemManager.PrefabManager.RegisterPrefab("bamboo", "OP_Bamboo_Wall_25");
			...
			//GameObject OP_Bamboo_Wall_45 = ItemManager.PrefabManager.RegisterPrefab("bamboo", "OP_Bamboo_Wall_45");
			...
			//OP_Bamboo_Ladder.RequiredItems.Add("OP_Bamboo_Wood", 2, true);
			//GameObject OP_Bamboo_Ladder = ItemManager.PrefabManager.RegisterPrefab("bamboo", "OP_Bamboo_Ladder");
			...
			OP_Ruin_Pillar_1.RequiredItems.Add("Stone", 1, true);
			OP_Ruin_Pillar_1.RequiredItems.Add("OP_Bamboo_Wood", 1, true);
			...
			OP_Ruin_Pillar_2.RequiredItems.Add("Stone", 1, true);
			OP_Ruin_Pillar_2.RequiredItems.Add("OP_Bamboo_Wood", 1, true);
			...
			OP_Ruin_Pillar_3.RequiredItems.Add("Stone", 1, true);
			OP_Ruin_Pillar_3.RequiredItems.Add("OP_Bamboo_Wood", 1, true);
			...
			OP_Rock_Formation_1.RequiredItems.Add("Stone", 1, true);
			OP_Rock_Formation_1.RequiredItems.Add("OP_Bamboo_Wood", 1, true);
			...
			OP_Rock_Formation_2.RequiredItems.Add("Stone", 1, true);
			OP_Rock_Formation_2.RequiredItems.Add("OP_Bamboo_Wood", 1, true);
			...
			OP_Rock_Formation_3.RequiredItems.Add("Stone", 1, true);
			OP_Rock_Formation_3.RequiredItems.Add("OP_Bamboo_Wood", 1, true);
			...
			OP_Rock_Formation_4.RequiredItems.Add("Stone", 1, true);
			OP_Rock_Formation_4.RequiredItems.Add("OP_Bamboo_Wood", 1, true);
